...
const AddRemoveHealthItem = () => {
  ...
  const exportToExcel = () => {
    ...
    saveAs(blob, 'health-products.xlsx');
  };
  ...
  const exportToPDF = () => {
    ...
    html2pdf().from(element).save('health-products.pdf');
  };
  ...
  const exportToWord = () => {
    ...
    saveAs(blob, 'health-products.doc');
  };
...
export default AddRemoveHealthItem;
