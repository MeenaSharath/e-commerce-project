...
const AddRemoveItem = () => {
  ...
  saveAs(blob, 'furniture-products.xlsx');
};
...
const exportToPDF = () => {
  ...
  html2pdf().from(element).save('furniture-products.pdf');
};
...
const exportToWord = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-3 px-4">
      <div className="max-w-6xl bg-white rounded-2xl shadow-lg p-5">
                    ...
                    <td className="py-1 px-4">
                      {item.image ? (
                        <img
                          src={item.image}
                          alt="Product"
                          className="w-20 h-16 object-cover mx-auto rounded-md shadow"
                        />
                      ) : (
