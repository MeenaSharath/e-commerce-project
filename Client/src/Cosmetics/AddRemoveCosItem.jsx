...
const AddRemoveCosItem = () => {
  ...
  const exportToExcel = () => {
    ...
    saveAs(blob, 'cosmetic-products.xlsx');
  };
  ...
  const exportToPDF = () => {
    ...
    html2pdf().from(element).save('cosmetic-products.pdf');
  };
  ...
  const exportToWord = () => {
    ...
    saveAs(blob, 'cosmetic-products.doc');
  };
...
export default AddRemoveCosItem;
