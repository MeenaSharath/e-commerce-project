...
const AddRemoveOffersItem = () => {
  ...
  useEffect(() => {
    axios
      .get('https://e-commerce-project-dashboard.onrender.com/offerspage')
  ...
  const handleDelete = (id) => {
    axios
      .delete('https://e-commerce-project-dashboard.onrender.com/deleteoffers/' + id)
    ...
    <div className="min-h-screen bg-gray-100 py-4 px-4">
      <div className="max-w-6xl bg-white rounded-2xl shadow-lg p-6">
        ...
        <div className="flex justify-end items-center gap-3 mb-3">
          <Link
            to="/createoffers"
            className="text-gray-400 hover:text-blue-400 text-l p-1 rounded-full transition-colors"
            title="Add New Item"
          >
            <FaPlus />
          </Link>
              ...
              <tbody>
                {currentProd.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="text-center">{item.off}%</td>
...
export default AddRemoveOffersItem;
