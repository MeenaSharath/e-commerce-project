...
const AddRemoveElectronicsItem = () => {
  ...
  const exportToExcel = () => {
    ...
    saveAs(blob, 'electronics-products.xlsx');
  };
  ...
  const exportToPDF = () => {
    ...
    html2pdf().from(element).save('electronics-products.pdf');
  };
  ...
  const exportToWord = () => {
    ...
    saveAs(blob, 'electronics-products.doc');
  };
...
export default AddRemoveElectronicsItem;
