...
function DashboardCard08() {
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
      <header className="px-5 border-b border-gray-100 dark:border-gray-700/60 flex items-center">
      <h2 className=" fs-4 font-semibold text-gray-800 dark:text-gray-100 mb-3 mt-2">Sales Over Time (all stores)</h2>
      </header>
