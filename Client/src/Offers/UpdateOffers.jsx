...
const UpdateOffers = () => {
  ...
  const Update = async (e) => {
    ...
    axios.put(`http://localhost:3001/updateOffers/${id}`, {
      ...
      .then(() => {
        navigate(`/addremoveoffersitems?page=${currentPage}`);
      })
      .catch(err => console.log(err));
  };

  return (
    <div className="flex justify-center items-center bg-gradient-to-r from-fuchsia-100 to-fuchsia-200 px-4 pt-8 pb-8">
      <div className="bg-white/90 backdrop-blur rounded-xl px-8 py-3 w-full max-w-xl shadow-lg border border-gray-200">
        <form className="w-full space-y-6" onSubmit={Update}>
          ...
          <div>
            <label htmlFor="name" className="block text-gray-700 font-medium mb-1">Description</label>
            <input
              type="text"
              id="description"
              value={des}
          ...
          <div>
            <label htmlFor="stock" className="block text-gray-700 font-medium mb-1">Offer</label>
            <input
              type="number"
              id="offer"
              value={off}
          ...
          <div>
            <label htmlFor="stock" className="block text-gray-700 font-medium mb-1">Rating</label>
            <input
              type="number"
              id="rating"
              value={rating}
          ...
          <button
            type="submit"
            className="w-full bg-fuchsia-200 hover:bg-fuchsia-300 text-white py-3 rounded-lg flex items-center justify-center gap-2 transition duration-200"
          >
            <FaEdit />
