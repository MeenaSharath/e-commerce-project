...
const AddHealth = () => {
  ...
  const Submit = async (e) => {
    ...
    try {
      await axios.post("http://localhost:3001/createHealth", {
        name,
        price: Number(price),
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-yellow-100 to-yellow-200 px-4 pb-10">
      <div className="backdrop-blur-lg bg-white/80 border border-gray-300 rounded-2xl px-8 py-3 w-full max-w-xl shadow-xl">
        <form className="w-full" onSubmit={Submit}>
          ...
          <div className="mb-4">
            ...
            <input
              type="text"
              placeholder="eg. Paracetamol Tablets – 20 Count"
          ...
          <button
            type="submit"
            className="w-full bg-yellow-200 text-white py-2 rounded-lg flex items-center justify-center gap-2 hover:bg-yellow-300 transition"
          >
