...
const AddEntertainment = () => {
  ...
  const Submit = async (e) => {
    ...
    try {
      await axios.post("http://localhost:3001/createEntertainment", {
        name,
        price: Number(price),
      ...
      navigate('/addremoveentertainmentitems');
    } catch (err) {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-blue-100 to-blue-200 px-4 pb-10">
