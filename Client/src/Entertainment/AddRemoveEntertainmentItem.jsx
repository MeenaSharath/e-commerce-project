...
const AddRemoveEntertainmentItem = () => {
  ...
  const exportToExcel = () => {
    ...
    saveAs(blob, 'entertainment-products.xlsx');
  };
  ...
  const exportToPDF = () => {
    ...
    html2pdf().from(element).save('entertainment-products.pdf');
  };
  ...
  const exportToWord = () => {
    ...
    saveAs(blob, 'entertainment-products.doc');
  };
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <div className="flex justify-center items-center gap-4">
                        <Link
                          to={`/entertainmentUpdate/${item._id}`}
                          state={{ currentPage }}
...
export default AddRemoveEntertainmentItem;
