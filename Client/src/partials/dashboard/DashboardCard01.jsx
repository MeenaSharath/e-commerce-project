...
function DashboardCard01() {
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl w-118">
      <div className="px-5">
        <header className="flex justify-between items-start mb-2">
          <h2 className=" fs-4 font-semibold text-gray-800 dark:text-gray-100 mb-3 mt-2">Sales Over Time</h2>
          </header>
           {/* Menu button}
      ...
      <div className="grow max-sm:max-h-[128px] xl:max-h-[128px]">
        ...
        <LineChart1 width={450} height={128} />
      </div>
    </div>
  );
}
